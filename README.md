...
This is an experimental benchmarking for all networking protocols. It was *originally* based on [Filament Group's experimental repo](https://github.com/filamentgroup/RWD-Table-Patterns), []() but has during the years grown up to be a more complete solution with new features.

## Demo:
https://ajudacomunitaria.github.io/networking-protocols
