...
# delfos
Delfos is an web-app unhosted/self-hosted experimental for benchmarking for all networking protocols, apps, standards, services, providers, frameworks, language programming, os and/or file formats with stats(from chart-js). It was *originally* based on [Filament Group's experimental repo](https://github.com/filamentgroup/RWD-Table-Patterns) but has during the years grown up to be a more complete solution with new features. Please see this [demo](https://eantho.github.io/delfos)
